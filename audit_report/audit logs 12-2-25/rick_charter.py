...
class RickCharter:
    ...
    MIN_EXPECTED_PNL_USD = 10.0  # Gross PnL at TP must be >= $10
    ...
    def validate(cls, test_key: Optional[str] = None) -> bool:
        ...
        try:
            ...
            assert cls.MIN_EXPECTED_PNL_USD == 10.0, "Expected PnL minimum error"
    ...
    def dynamic_min_expected_pnl(cls, market_conditions: Dict[str, float]) -> float:
        ...
        return max(base_pnl, 50.0)  # Ensure a minimum threshold of $50

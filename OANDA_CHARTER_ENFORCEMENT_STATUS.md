...
- **Enforcement Points:**
    - Line 324: `EXPECTED_PNL_BELOW_MIN` - Blocks orders with expected P&L < $35
  - Line 252-294: `MIN_NOTIONAL` - Blocks/rejects orders < $15,000 notional
  - Line 310: `CHARTER_VIOLATION` logging to narration system

#### 📋 **Charter Files**
- **root charter** (`rick_charter.py`): ✅ Has `MIN_EXPECTED_PNL_USD = 35.0`
...
|-----------|--------|--------------|
| Expected P&L < $35 | **BLOCK ORDER** | `CHARTER_VIOLATION` code=`MIN_EXPECTED_PNL_USD` |

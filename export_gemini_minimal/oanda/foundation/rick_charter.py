...
class RickCharter:
    # Backwards-compatible expected PnL threshold used by connectors and legacy code
    MIN_EXPECTED_PNL_USD = 35.0  # Gross PnL at TP must be >= $35
    # Legacy alias for older connectors that still reference MIN_PROFIT_USD
    MIN_PROFIT_USD = MIN_EXPECTED_PNL_USD  # legacy alias — DO NOT USE DIRECTLY
    """
    ...
    MAX_MARGIN_UTILIZATION_PCT = 1.75  # 175% maximum margin utilization (Balanced Profile)

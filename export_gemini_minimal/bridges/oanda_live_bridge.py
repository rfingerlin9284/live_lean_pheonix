...
def calculate_sl_tp(direction, entry_price, units, min_profit_usd: float = None, rr_ratio=3.2):
    pip = 0.0001
    risk_pips = 20
    ...
    min_profit_distance = min_expected / units
...
def main():
    ...
    print(f"  Enforcement: >=$15k notional, >=$35 profit, RR>=3.2, OCO mandatory")
    print("=" * 80)

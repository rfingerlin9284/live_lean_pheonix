...
load_dotenv("/home/ing/RICK/R_H_UNI/.env")
...
[Service]
Type=oneshot
ExecStart=/bin/bash -lc '~/.local/bin/pg_now > /home/ing/RICK/R_H_UNI/logs/actions_now.json.tmp 2>/dev/null && mv /home/ing/RICK/R_H_UNI/logs/actions_now.json.tmp /home/ing/RICK/R_H_UNI/logs/actions_now.json || echo "{\"error\": \"pg_now failed\"}" > /home/ing/RICK/R_H_UNI/logs/actions_now.json'
